    ...
    protected function _toHtml()
    {
        ...
        if(isset($requestData['result']) && $requestData['result']=='success'){
           ...
           // $html .= '<script type="text/javascript"> window.location.href = '. $url.'; </script>';
            ...
            $html = '<html><body>';
            $html .= '<h1 style="padding: 15px; vertical-align: middle; display: flex; justify-content: center; align-items: center;"><a href="'. $this->geturl().'"><img src="'. $logoSrc.'" alt="eonbazar.com" /></a> </h1>';
